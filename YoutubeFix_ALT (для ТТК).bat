...
set LIST_TITLE=ZAPRET: YouTube Fix ALT TTK
...
--filter-tcp=80 --hostlist="%LIST_PATH%" --dpi-desync=fake,split2 --dpi-desync-ttl=2 --dpi-desync-autottl=5 --dpi-desync-fooling=md5sig --new ^
--filter-tcp=443 --hostlist="%LIST_PATH%" --dpi-desync=fake,split2 --dpi-desync-ttl=2 --dpi-desync-autottl=5 --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin"